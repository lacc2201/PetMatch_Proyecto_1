<template>
    <div>
        ...
        <section class="reviews-section">
            ...
            <div class="review-card">
                <div class="review-header">
                    <img src="https://via.placeholder.com/80" alt="Foto del Cliente" class="client-photo">
                ...
                <div class="review-content">
                    <div class="pet-photo">
                        <img src="https://via.placeholder.com/300x200" alt="Foto de la Mascota">
                    </div>
                    <div class="pet-info">
                        <h4>Rocky</h4>
                        <p><strong>Estado de la Mascota:</strong> Saludable y lleno de energía.</p>
                        <p>
                            Estoy muy contento con Rocky, es un perro muy cariñoso y se adaptó rápidamente a nuestra familia.
                            El proceso de adopción fue sencillo y el personal muy amable. ¡Recomiendo este lugar a todos!
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="review-card">
                ...
                <div class="review-content">
                    ...
                    <div class="pet-info">
                        ...
                        <p>
                            Luna es la gata más dulce que he conocido. Desde que llegó a casa ha llenado nuestros días de alegría.
                            El servicio fue excelente y se aseguraron de que Luna estuviera en perfectas condiciones. ¡Gracias!
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="review-card">
                ...
                <div class="review-content">
                    ...
                    <div class="pet-info">
                        <h4>Max</h4>
                        <p><strong>Estado de la Mascota:</strong> Ligera lesión en la pata trasera, en recuperación.</p>
                        <p>
                            Max es un perro muy valiente y a pesar de su lesión se muestra muy juguetón.
                            El centro nos informó de todo y nos dio las indicaciones necesarias para su cuidado. Estamos felices con él.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div v-if="isModalVisible" class="modal" @click.self="closeReviewModal">
...
<script>
export default {
    name: "CustomerReviews", // Cambia el nombre aquí
    data() {
        return {
    ...
    methods: {
        openReviewModal() {
            if (!this.isUserAuthenticated()) {
                alert('Por favor, inicie sesión para agregar una reseña.');
